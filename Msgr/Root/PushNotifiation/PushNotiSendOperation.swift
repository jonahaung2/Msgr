...
final class PushNotiSendOperation: Operation {
    ...
    private let contact: Contact.Payload
    ...
    init(_ msg_: Msg.Payload, contact: Contact.Payload) {
        self.payload = msg_
    ...
    override func start() {
        ...
        guard !isCancelled, let token = contact.pushToken else {
        ...
        notification["subtitle"] = contact.phone
